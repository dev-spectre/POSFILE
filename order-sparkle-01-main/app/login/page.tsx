          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link href="/forgot-password" className="text-[10px] font-black uppercase tracking-widest text-orange-500 hover:text-orange-600 transition-colors">
                  Forgot?
                </Link>
              </div>
              <div className="relative group">
            ...
            <div className="text-center mt-8 pt-6 border-t border-slate-100 dark:border-slate-800">
              <p className="text-slate-500 font-medium">
                New to Fast Billing?{' '}
                <Link href="/signup" className="text-orange-500 font-black hover:underline underline-offset-4">
                  Sign Up
                </Link>
              </p>
            </div>
