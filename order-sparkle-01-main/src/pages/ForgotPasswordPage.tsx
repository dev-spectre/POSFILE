      ...
      >
        <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-[2.5rem] shadow-2xl overflow-hidden p-8 sm:p-12 border border-white/20">
          <div className="mb-10 flex flex-col items-center">
             <Link to="/login" className="self-start mb-6 p-2 rounded-xl text-slate-400 hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-slate-800 transition-all flex items-center gap-2 font-bold text-sm">
